...
#need to run cronjob to place orders once live data issues is sorted
...
for symbol in symbols:
    ...
    # "after_opening_range_breakout" filters "after_opening_range_mask" for data which is higher than the high in the price range of first 15 minutes
    ...
    # print("opening_range_bars",opening_range_bars)
    # print("after_opening_range_breakout",after_opening_range_breakout)

    #Limit_price is the first cell in the "after_opening_range_breakout"
    if not after_opening_range_breakout.empty  and opening_range > 0.01:
